<?php
	...
	if(isset($_POST['reset'])){
		...
		if($row['numrows'] > 0){
			...
			try{
				$stmt = $conn->prepare("UPDATE customer SET reset_code=:code WHERE id=:id");
				...
				$message = "
					...
					<a href='http://veshbusha.com/loginl/forget/password_reset.php?code=".$code."&user=".$row['id']."'>Reset Password</a>
				";
